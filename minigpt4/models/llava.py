...
class LLaVa(BaseModel):
    ...
    def generate(
        ...
        if findings_kwargs!=None and findings_kwargs.get("vit_token_debug", False) :
            return output_text, outputs, output_ids[:, input_token_len:]
        else:
            return output_text
